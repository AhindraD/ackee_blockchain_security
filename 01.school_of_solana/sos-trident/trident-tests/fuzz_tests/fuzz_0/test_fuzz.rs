...
fn main() {
    loop {
        fuzz_trident!(fuzz_ix: FuzzInstruction, |fuzz_data: MyFuzzData| {
            ...
            let fuzzing_program1 = FuzzingProgram::new(PROGRAM_NAME_UNAUTHORIZED_ACCESS_2,&PROGRAM_ID_UNAUTHORIZED_ACCESS_2,processor!(convert_entry!(entry_unauthorized_access_2)));
